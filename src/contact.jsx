 ...
 return (
  <div className="Contact-Hero bg-black">
   <div className="container py-5 px-6  mx-auto ">
    <h3 className="mt-5  pt-5 text-2xl font-bold text-yellow-500 text-center">Contact Us For more details</h3>
    ...
    <div className="grid grid-cols=1 md:grid-cols-2">
     ...
     <div className="item-1 flex justify-start pe-3">
       <div className="ico-items bg-yellow-500 mt-2 flex w-[30px] h-[30px] rounded-full items-center justify-center px-2 ">
       < GrLocation/>

       </div>

       <div className="item-info ps-3">
        <h4 className="pt-1 text-yellow-500">Address</h4>
      ...
      <div className="item-1 flex justify-start pe-3">
       <div className="ico-items bg-yellow-500 mt-2 flex items-center justify-center " style={{ width: "30px", borderRadius: "50%", height: "30px" }}>
        <BsTelephone />

       </div>

       <div className="item-info ps-3">
        <h4 className="pt-1 text-yellow-500">Phone</h4>
      ...
      <div className="item-1 flex justify-start pe-3">
       ...
       <div className="item-info ps-3">
        <h4 className="pt-1 fs-5 text-yellow-500">Email</h4>
      ...
      <div className="item-1 flex justify-start pe-3">
       ...
       <div className="item-info ps-3">
        <h4 className="pt-2 fs-5 text-yellow-500">Account Name:</h4>
        <p className=" text-white">NicholasMotivates initiative</p>
        <h4 className="pt-2 fs-5 text-yellow-500">Bank:</h4>
        <p className="pt-2 text-white">Bank: GTB</p>

        <h4 className="pt-2 fs-5 text-yellow-500">Account Number:</h4>
     ...
     <div className="form">
      ...
      <form className="  mx-2 px-2 my-5 bg-white shadow-lg " ref={form} onSubmit={sendEmail}>
       ...
       <div className="email-send flex  flex-col ">
        ...
        <input type="Email" className="py-2  border border-b-yellow-500 shadow-md border-double  ps-5 mt-2 w-[300px] text-base  rounded-lg " name="user_email" required placeholder="Email"></input>
       ...
       <div className="email-send flex flex-col ">
        ...
        <textarea className="w-[300px] h-[200px]   text-gray-600 ps-5 py-5  border border-b-yellow-500 shadow-md border-double text-base" name="message" placeholder="Message" cols="6"
         rows="3"></textarea>
       </div>
       ...
       <div className="email-send flex flex-col ">
        ...
        {!loading && <input type="submit" className=" hover:bg-black hover:text-white font-bold text-base flex place-self-start rounded-md  px-5 py-2 my-3 bg-yellow-500 text-black" value="Send" />}
        {loading && <input type="submit" className="text-base flex place-self-start rounded-md px-5 py-2  my-3 bg-yellow-500" disabled value="Sending" />}
       </div>
